        ...
        <div className="columns">
          ...
          <div className="column">
            <div className="box has-text-centered">
              ...
              <p className="subtitle is-size-6" title={props.esmSum}>{/*t('daistats.total_MKR_burned')}*/}Total GSUp Burned: {formatSixDp.format(props.esmSum)}</p>
          ...
          <div className="column">
            <div className="box has-text-centered">
              ...
              <p className="subtitle is-size-4">{
                t('daistats.token_supply', { token: 'GSUp (ERC20)' })} ({formatAmount.format(props.daiSupply / props.debt * 100)}%)
              </p>
            </div>
          </div>
          <div className="column">
        ...
        <div className="columns">
          ...
          <div className="column">
            <div className="box has-text-centered">
              ...
              <p className="subtitle is-size-4">{t('daistats.token_in_dex', { token: 'GSUc', dex: 'gsucoin Dex' })}</p>
            </div>
          </div>
          <div className="column">
            <div className="box has-text-centered">
          ...
          <div className="column">
            <div className="box has-text-centered">
              <a href={`https://etherscan.io/address/${props.DAIF_WALLET}`} target="_blank" rel="noopener noreferrer">
                <h3 className="title"><i className="fal fa-file-code"></i> GSUc Foundation Core Unit</h3>
          ...
          <div className="column">
            <div className="box has-text-centered">
              <a href={`https://etherscan.io/address/${props.DAIF_EF_WALLET}`} target="_blank" rel="noopener noreferrer">
                <h3 className="title"><i className="fal fa-file-code"></i> GSUc Foundation Emergency Fund</h3>
